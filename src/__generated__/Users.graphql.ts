...
export type Users$data = {
  ...
  readonly " $fragmentType": "Users";
};
export type Users$key = {
  readonly " $data"?: Users$data;
  readonly " $fragmentSpreads": FragmentRefs<"Users">;
};

import UsersPaginatedQuery_graphql from './UsersPaginatedQuery.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": UsersPaginatedQuery_graphql
    }
  },
  "name": "Users",
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__UsersPaginatedQuery_adminUsers_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
